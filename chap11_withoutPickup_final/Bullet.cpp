	...
	float targetX, float targetY)
{
	...
	//******As per the BOOK: Calculate the gradient of the flight path
	 //float gradient = (startX - targetX) / (startY - targetY);
	//**********************************************************//
	
	//*******MODIFIED: Calculate the gradient of the flight path****/
	...
	//******As per the BOOK, set spped horizontally and vertically******/
	...
	//*****MODIFIED: Set spped horizontally and vertically******/
